projects = window.researchProjects

const container = document.getElementById('research-container');
const template = document.getElementById('research-item-template');
...
projects.forEach(project => {
    ...
    clone.querySelector('a.btn').href = `researchProjectPage.html?id=${id}`;
